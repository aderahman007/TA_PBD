...
public class MakhorijulHurufActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_makhorijul_huruf);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(PenjelasanMakhorijulHurufFragment.newInstance(), "Penjelasan");
        adapter.addFragment(ContohMakhorijulHurufFragment.newInstance(), "Contoh");
