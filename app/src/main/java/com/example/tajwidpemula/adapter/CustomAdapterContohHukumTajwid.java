...
public class CustomAdapterContohHukumTajwid extends RecyclerView.Adapter<CustomAdapterContohHukumTajwid.ViewHolder> {

    private String[] SubjectValues;
    private Context context;

    public CustomAdapterContohHukumTajwid(String[] SubjectValues1) {
    ...
    @NonNull
    @Override
    public CustomAdapterContohHukumTajwid.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
