 ...
 */
public class PenjelasanHukumTajwidFragment extends Fragment {

    public PenjelasanHukumTajwidFragment() {
        // Required empty public constructor
    }

    public static PenjelasanHukumTajwidFragment newInstance() {

        Bundle args = new Bundle();

        PenjelasanHukumTajwidFragment fragment = new PenjelasanHukumTajwidFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_penjelasan_hukum_tajwid, container, false);
